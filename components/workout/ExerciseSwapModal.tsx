          ...
          {muscleCategories.map(category => (
            <TouchableOpacity
              ...
              style={[
                styles.categoryChip,
                {
                  backgroundColor: selectedCategory === category ? muscleCategoryColors[category] : palette.cardBg,
          ...
          {filteredExercises.length === 0 ? (
            <View style={[styles.emptyState, { backgroundColor: palette.cardBg, borderColor: palette.cardBorder }]}>
              ...
              <Text style={[styles.emptyDescription, { color: palette.textMuted }]}>
                {searchQuery || selectedCategory ? 'Try adjusting your filters' : 'No exercises in library'}
              </Text>
            </View>
          ) : (
